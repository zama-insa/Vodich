		...
		<c:choose>
			<c:when test="${empty scenarii}">
				<div class="alert alert-success alert-dismissible" role="alert">
					...
					<a href="create"><fmt:message
							key="message_default_no_scenario_3" /></a>
				</div>
			</c:when>
			<c:otherwise>
				<div class="row">
									...
									<div class="panel-heading" role="tab"
										...
										<div class="row">
											<div class="col-md-5">
												<h4 class="panel-title">
													<a role="button" data-toggle="collapse"
														...
														${scenario.name } </a> <a href="result"> <span
														class="badge"
														title="${scenario.name} launched ${scenario.totalLaunches} times">${scenario.totalLaunches}</span>
													</a>
												</h4>
											</div>
											<div class="col-md-5 col-md-offset-2">
												...
												<a class="btn btn-primary" type="button" id="btnExport"
													href="export?id=<c:out value="${scenario.id}"/>"
													target="_blank"> <fmt:message key="message_export" /></a>
											</div>
										</div>
									</div>
									<div id="<c:out value="${scenario.id}"/>"
										...
										<div class="panel-body">
											...
											<div class="row">
												...
												<div class="col-md-8">
													<div id="timeline<c:out value="${scenario.id}"/>"></div>
												</div>
											</div>
										</div>
